...
class Empresa(Base):
    ...
    compras_productos_taxonomia_version = Column(Integer, nullable=True)
    ...
    duchas = Column(Boolean, nullable=True)
    agua_caliente = Column(Boolean, nullable=True)
    electricidad = Column(Boolean, nullable=True)
    proveeduria = Column(Boolean, nullable=True)
    mesas = Column(Boolean, nullable=True)
    quinchos = Column(Boolean, nullable=True)
    motorhome = Column(Boolean, nullable=True)
...
class DestinoContenido(Base):
    ...
    estacionamiento_resumen = Column(Text, nullable=True)
    estacionamiento_descripcion = Column(Text, nullable=True)
    estacionamiento_auto = Column(String, nullable=True)
    estacionamiento_moto = Column(String, nullable=True)
    estacionamiento_asadores = Column(String, nullable=True)
    estacionamiento_servicios = Column(Text, nullable=True)
    estacionamiento_asadores_nota = Column(Text, nullable=True)
    estacionamiento_nota = Column(Text, nullable=True)
    recomendaciones = Column(Text, nullable=True)
