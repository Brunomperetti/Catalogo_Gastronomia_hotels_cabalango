...
def test_all_public_css_consumers_use_commerce_cache_key():
    ...
    for template in templates:
        ...
        expected_version = "?v=20260825-weather-spacing-1" if template == "descubri_cabalango.html" else "?v=20260814-provider-lightbox-sizing-1" if template == "prestador.html" else "?v=20260818-agenda-official-1" if template == "actividades.html" else "?v=20260810-commerce-services-1"
