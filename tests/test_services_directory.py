...
def test_all_public_css_consumers_use_commerce_cache_key():
    ...
    for template in templates:
        ...
        expected_version = "?v=20260902-home-single-event-balance-1" if template == "descubri_cabalango.html" else "?v=20260831-provider-promo-cascade-fix-2" if template == "prestador.html" else "?v=20260901-agenda-card-alignment-2" if template == "actividades.html" else "?v=20260831-activity-gallery-polish-2" if template == "actividad_detalle.html" else "?v=20260902-accommodation-filters-ux-1" if template == "portal_prestadores.html" else "?v=20260810-commerce-services-1"
