...
def camping_app(monkeypatch):
    ...
    camping = Empresa(
        ...
        subtipo="Camping", activo=True, capacidad="400", habitaciones="0", horarios="",
...
def test_camping_detail_uses_specific_facts_and_hides_irrelevant_data(camping_app):
    ...
    for value in ("Camping", "Hasta 400 personas", "Tarifa orientativa", "$10.000 por persona", "Duchas", "Agua caliente", "Electricidad", "Acepta motorhome", "Quinchos"):
...
def test_admin_edits_camping_and_normalizes_type(camping_app):
    ...
    response = client.post("/empresa/editar_panel", data={
        ...
        "subtipo": " CAMPING ", "capacidad": "450", "duchas": "1", "electricidad": "1", "motorhome": "1",
