...
def test_public_templates_load_the_approved_font_families_once():
    for name in PUBLIC_TEMPLATES:
        ...
        expected_version = "?v=20260908-home-photo-signature-1" if name == "descubri_cabalango.html" else "?v=20260904-provider-single-gallery-1" if name == "prestador.html" else "?v=20260914-accommodation-cards-1" if name == "portal_prestadores.html" else "?v=20260810-commerce-services-1"
