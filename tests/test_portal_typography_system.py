...
def test_public_templates_load_the_approved_font_families_once():
    for name in PUBLIC_TEMPLATES:
        ...
        expected_version = "?v=20260825-weather-editorial-1" if name == "descubri_cabalango.html" else "?v=20260814-provider-lightbox-sizing-1" if name == "prestador.html" else "?v=20260810-commerce-services-1"
