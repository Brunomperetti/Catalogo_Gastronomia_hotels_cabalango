...
def test_public_templates_load_the_approved_font_families_once():
    for name in PUBLIC_TEMPLATES:
        ...
        expected_version = "?v=20260826-weather-refresh-15" if name == "descubri_cabalango.html" else "?v=20260831-provider-promo-cascade-fix-2" if name == "prestador.html" else "?v=20260902-accommodation-filters-ux-1" if name == "portal_prestadores.html" else "?v=20260810-commerce-services-1"
