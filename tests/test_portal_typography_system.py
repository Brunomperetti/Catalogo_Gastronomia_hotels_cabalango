...
def test_public_templates_load_the_approved_font_families_once():
    for name in PUBLIC_TEMPLATES:
        ...
        expected_version = "?v=20260812-home-art-2" if name == "descubri_cabalango.html" else "?v=20260814-provider-promo-lightbox-1" if name == "prestador.html" else "?v=20260810-commerce-services-1"
